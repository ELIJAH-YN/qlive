...
{{--                    </div>--}}
            ...
            <div class="row">
                <div class="col-sm-6  wow fadeInUpBig u-mb-24" data-wow-delay="0.8s">
                    <img class="img" src="images/model/p2.jpg" alt="">
{{--                    <div class="modelcard_imge">--}}
{{--                        <div class="imgbox u-BorderRradius-8">--}}
...
{{--                    </div>--}}
            ...
            <div class="modelcard_information">
                <ul class="modelcard_information_List">
                    <li class=" wow bounceIn" data-wow-delay="0.3s">編號</li>
                    <li class=" wow bounceIn" data-wow-delay="0.6s">身高</li>
                    <li class=" wow bounceIn" data-wow-delay="0.9s">體重</li>
                    <li class=" wow bounceIn" data-wow-delay="1.2s">三圍</li>
                    <li class=" wow bounceIn" data-wow-delay="1.5s">鞋號</li>
                    <li class=" wow bounceIn" data-wow-delay="1.8s">FB追蹤人數</li>
                    <li class=" wow bounceIn" data-wow-delay="2.1s">IG追蹤人數</li>
